...
public void the_user_is_in_a_page_having_an_try_editor_with_a_run_button_to_test(String option) {
	driver.navigate().to(ConfigReader.stackPage());
	stackPage.stackmenu_click(option);
...
public void the_user_is_on_the_arrays_in_python_after_logged_in() {
	driver.navigate().to(ConfigReader.stackPage());
	stackPage.operationstack_click();
}  

@When("The user clicks stack Practice Questions link")
public void the_user_clicks_practice_questions_link() {
	stackPage.practice_click();
}

@Then("The user should be redirected to {string} page in stack")
